CLASS zcl_generate_travel_data_rd DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_rd IMPLEMENTATION.
METHOD: if_oo_adt_classrun~main.

DATA:  itab type TABLE OF ztravel_rd.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_rd.

*   insert the new table entries
    INSERT ztravel_rd FROM TABLE @itab.
